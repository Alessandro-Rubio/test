import React, { useState, useRef } from "react"; // <-- Importa useState
...
import ChatbotComponent from "../chatbot/ChatbotComponent"; // Importa el componente del chatbot
import '../styles/Chatbot.css'; // Importa los nuevos estilos
...
function CodeVerification() {
  ...
  // --- INICIO: NUEVO ESTADO Y LÓGICA ---
  const [isChatOpen, setIsChatOpen] = useState(false); // Estado para abrir/cerrar el chat

  const toggleChat = () => {
    setIsChatOpen(prevState => !prevState); // Función para cambiar el estado
  };
  // --- FIN: NUEVO ESTADO Y LÓGICA ---


  const onSubmit = () => {
    // ... (tu lógica de onSubmit se mantiene igual)
  ...
  const handleInput = (e, idx) => {
    // ... (tu lógica de handleInput se mantiene igual)
  ...
  const handleKeyDown = (e, idx) => {
    // ... (tu lógica de handleKeyDown se mantiene igual)
  ...
  return (
    <div className="App">
      ...
      {/* --- INICIO: BURBUJA Y VENTANA DEL CHATBOT --- */}
      ...
      {/* --- FIN: BURBUJA Y VENTANA DEL CHATBOT --- */}
